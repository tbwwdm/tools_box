...
class IMSToolPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "IMS工具"
    @property
    def plugin_name_en(self) -> str: return "IMS Tool"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "📦"
    @property
    def plugin_description(self) -> str: return "IMS 抓包、网元升级、日志查看"
    @property
    def plugin_description_en(self) -> str: return "IMS capture, NE upgrade, log viewer"
    @property
    def plugin_tags(self) -> list: return ["ims", "telecom"]
