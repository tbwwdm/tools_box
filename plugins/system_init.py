...
class SystemInitPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "系统初始化"
    @property
    def plugin_name_en(self) -> str: return "System Init"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "⚙️"
    @property
    def plugin_description(self) -> str: return "批量执行系统安全加固与初始化任务"
    @property
    def plugin_description_en(self) -> str: return "Batch system security hardening and init tasks"
    @property
    def plugin_tags(self) -> list: return ["init", "linux", "security"]

    def create_widget(self, parent=None):
        return LinuxBaseConfig()
