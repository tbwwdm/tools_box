...
class PasswordPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "密码生成器"
    @property
    def plugin_name_en(self) -> str: return "Password Generator"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "🔑"
    @property
    def plugin_description(self) -> str: return "生成随机密码，支持单/批量生成、Excel处理"
    @property
    def plugin_description_en(self) -> str: return "Generate passwords, batch mode, Excel support"
    @property
    def plugin_tags(self) -> list: return ["security", "password"]
