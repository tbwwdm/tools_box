...
class IPv6Plugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "IPv6掩码计算器"
    @property
    def plugin_name_en(self) -> str: return "IPv6 Calculator"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "🌐"
    @property
    def plugin_description(self) -> str: return "IPv6 地址展开/压缩、Prefix 计算、类型识别"
    @property
    def plugin_description_en(self) -> str: return "IPv6 expand/compress, prefix calculation, type detect"
    @property
    def plugin_tags(self) -> list: return ["network", "ipv6"]

    def create_widget(self, parent=None):
        return IPv6CalculatorApp()
