...
class PDFPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "PDF工具集"
    @property
    def plugin_name_en(self) -> str: return "PDF Tools"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "📄"
    @property
    def plugin_description(self) -> str: return "PDF 合并、拆分、A4多页拼版，支持拖拽"
    @property
    def plugin_description_en(self) -> str: return "PDF merge, split, multi-page layout, drag-drop"
    @property
    def plugin_tags(self) -> list: return ["pdf", "document"]
