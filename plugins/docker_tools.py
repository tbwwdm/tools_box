...
class DockerPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "Docker自动化"
    @property
    def plugin_name_en(self) -> str: return "Docker Automation"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "🐳"
    @property
    def plugin_description(self) -> str: return "远程 Docker 管理：容器、镜像、网络、批量操作"
    @property
    def plugin_description_en(self) -> str: return "Remote Docker: containers, images, network"
    @property
    def plugin_tags(self) -> list: return ["docker", "container"]
