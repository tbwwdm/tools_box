...
class LinuxToolsPlugin(PluginBase):
    @property
    def plugin_name(self) -> str: return "Linux工具集"
    @property
    def plugin_name_en(self) -> str: return "Linux Tools"
    @property
    def plugin_version(self) -> str: return "1.0.0"
    @property
    def plugin_icon(self) -> str: return "💻"
    @property
    def plugin_description(self) -> str: return "Linux 服务器管理：用户管理、SSH 配置、安全基线检查"
    @property
    def plugin_description_en(self) -> str: return "Linux server management: users, SSH, security baseline"
    @property
    def plugin_tags(self) -> list: return ["linux", "admin"]

    def create_widget(self, parent=None):
        return LinuxToolsGUI()
