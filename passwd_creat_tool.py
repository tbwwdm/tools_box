...
密码生成工具 (PySide6)
"""
import sys, os, re, logging, secrets, string, json
...
class PasswdTool(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("""
            ...
            QGroupBox { font-weight:bold; color:#2d3436; border:none; margin-top:10px; padding:0; }
            QGroupBox::title { padding:0 0 4px 0; border-bottom:2px solid #0984e3; }
    ...
    def _btn(self, text, color="#0984e3"):
